    ...
    return (
        <nav className="nav">
            <div className="nav__items">
                ...
                <div className="nav__item"><NavLink activeClassName="activeLink" to="/users">Users</NavLink></div>
                ...
                <div className="nav__item"><NavLink activeClassName="activeLink" to="/friends">Sidebar</NavLink></div>
